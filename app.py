...
def send_message(content, bot_id, old_message):
	...
	requests.post('https://api.groupme.com/v3/bots/post', json={'bot_id': bot_id, 'text': content, 'attachments': ["loci": [0], "type": "mentions", "user_ids": [old_message['user_id']]]}, headers=headers)
